<aside class="col-lg-4">
				...
				<!--Panel logowanie-->
				<form role="form" class="panel-group form-horizontal" action="accounts/login.php" method="POST">
					<div class="panel panel-default">
					<div class="panel-heading">Login Area</div>
						<div class="panel-body">
							...
							<div class="form-group">
								...
								<div class="col-sm-7">
									<input type="text" id="username" class="form-control" name="user_name" placeholder="Insert Email Address">
								</div>
							</div>

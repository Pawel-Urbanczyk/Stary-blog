			...
			<ul class="nav navbar-nav navbar-right">
				...
				<!--Menu-->
					...
					while($rows = mysqli_fetch_assoc($run_cat)){
						//oznaczenie aktualnie aktywnego menu
						...
						if($rows['category_name'] == 'home'){
							if($_SERVER['PHP_SELF'] == '/System/index.php'){
						...
						echo '
							<li class="'.$class.'"><a href="menu.php?cat_id='.$rows['c_id'].'">'.ucfirst($rows['category_name']).'</a></li>
						';
